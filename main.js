  ...
  const navHTML = `
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-group">
        ...
        <a href="${docsPath}04-sitemap.html"><span class="nav-number">02</span> サイトマップ</a>
        <a href="${docsPath}05-wireframe.html"><span class="nav-number">03</span> ワイヤーフレーム</a>
        <a href="${docsPath}06-design-guide.html"><span class="nav-number">04</span> デザインガイドライン</a>
        <a href="${docsPath}10-retrospective.html"><span class="nav-number">05</span> 振り返り・技術記事</a>
      </div>
      <div class="nav-group">
        <div class="nav-group-title">設計資料</div>
        <a href="${docsPath}07-specification.html"><span class="nav-number">06</span> 仕様書</a>
        <a href="${docsPath}08-db-design.html"><span class="nav-number">07</span> DB設計書</a>
        <a href="${docsPath}09-test-report.html"><span class="nav-number">08</span> テスト報告書</a>
